        ...
        <el-row type="flex" class="tableBox" justify="center">
          ...
          <el-col :span="20">
            <el-table :data="tableData" border fit style="width: 100%;height:500px;">
              ...
              <el-table-column label="督办号" prop="wjlx" align="center" :resizable="false"> </el-table-column>
              <el-table-column label="来文时间" prop="wjlx" align="center" :resizable="false"> </el-table-column>
              <el-table-column label="来文单位/个人" prop="wjlx" align="center" :resizable="false"> </el-table-column>
              <el-table-column label="来文内容" prop="wjlx" align="center" :resizable="false"> </el-table-column>
              <el-table-column label="批示人" prop="wjlx" align="center" :resizable="false"> </el-table-column>
              <el-table-column label="批示时间" prop="wjlx" align="center" :resizable="false"> </el-table-column>
              <el-table-column label="批示内容" prop="wjlx" :resizable="false" align="center"> </el-table-column>
              <el-table-column label="责任单位" :resizable="false" prop="wjlx" align="center"> </el-table-column>
              <el-table-column label="要求办结时间" :resizable="false" prop="wjlx" align="center"> </el-table-column>
              <el-table-column label="实际办结时间" :resizable="false" prop="wjlx" align="center"> </el-table-column>
