    ...
    <div class="container">
      ...
      <el-card class="box-card">
        ...
        <el-table :data="tableData" style="width: 100%;height:500px;">
          ...
          <el-table-column label="单位" prop="wjlx" align="center">
          </el-table-column>
          <el-table-column label="送件人" prop="wjlx" align="center">
          </el-table-column>
          <el-table-column label="电话" prop="wjlx" align="center">
          </el-table-column>
          <el-table-column label="送呈领导" prop="wjlx" align="center">
          </el-table-column>
          <el-table-column label="标题" prop="wjlx" align="center">
          </el-table-column>
        </el-table>
      </el-card>
    </div>
