    ...
    <div class="container">
      <div class="navigation">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>传阅件情况一览表</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
...
export default {
  ...
  methods: {
    ...
    InitialValue(time1, time2) {
      const value = `传阅件情况一览表（${time1}-${time2}）`
      return value
    },
    // 搜索按钮
    search() {
    ...
    // excel 数据导出
    exportToExcel() {
      const tHeader = ['序号', '流水号', '来文单位', '文号', '文件标题', '备注']
      const filterVal = ['wjlx', 'wjlx', 'wjlx', 'wjlx', 'wjlx', 'wjlx']
