    ...
    <el-row type="flex" justify="space-between">
      <el-col :span="8">
        ...
        <el-form-item label="领衔代表：">
          <el-input v-model="ruleForm.leadingMember" style="width:100%" placeholder="请输入领衔代表"></el-input>
        </el-form-item>
      ...
      <el-col :span="8">
        ...
        <el-form-item label="代表团：">
          <el-input v-model="ruleForm.delegation" style="width:100%" placeholder="请输入代表团"></el-input>
        </el-form-item>
        <el-form-item label="人大建议编号：">
          <el-input v-model="ruleForm.number" style="width:100%" placeholder="请输入人大建议编号"></el-input>
        </el-form-item>
