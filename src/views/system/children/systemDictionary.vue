    ...
    <el-row type="flex" justify="space-around">
      <el-col :span="18">
        <el-form :model="form" inline>
          <el-form-item label="">
            <el-select v-model="form.tld" placeholder="请选择字典类别">
              <el-option label="厅领导" :value="1"></el-option>
              <el-option label="紧急程度" :value="0"></el-option>
          ...
          <el-form-item label="">
            <el-input v-model="form.str" style="width:300px" placeholder="请输入字典编码或名称"></el-input>
          </el-form-item>
        </el-form>
      </el-col>
      <el-col :span="4">
    ...
    <el-row type="flex" justify="space-around">
      <el-col :span="23">
        <el-table :data="tableData" border style="width: 100%" height="500">
          ...
          <el-table-column prop="zdlb" label="字典类别" align="center"> </el-table-column>
          <el-table-column prop="px" label="排序" align="center"> </el-table-column>
          <el-table-column prop="zddm" label="字典代码" align="center"> </el-table-column>
          <el-table-column prop="zdmc" label="字典名称" align="center"> </el-table-column>
          <el-table-column prop="zt" label="当前状态" align="center" width="100px">
      ...
      <el-row>
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
          <el-form-item label="字典类别" prop="name">
            <el-select v-model="ruleForm.name" style="width:100%" placeholder="请选择字典类别">
              <el-option label="厅领导" :value="1"></el-option>
              <el-option label="紧急程度" :value="0"></el-option>
              <el-option label="..." :value="2"></el-option>
            </el-select>
          ...
          <el-form-item label="字典编号" prop="name">
            <el-input v-model="ruleForm.name" disabled placeholder="字典编号自动生成"></el-input>
          </el-form-item>
          <el-form-item label="字典名称" prop="name">
            <el-input v-model.number="ruleForm.name" placeholder="请输入字典名称"></el-input>
          </el-form-item>
          <el-form-item label="字典排序" prop="name">
            <el-input v-model="ruleForm.name" placeholder="请输入排序"></el-input>
          </el-form-item>
        </el-form>
      </el-row>
      <span slot="footer">
