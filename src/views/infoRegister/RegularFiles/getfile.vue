      ...
      <div class="navigation">
        <div class="navigation-left">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>上级来文</el-breadcrumb-item>
          </el-breadcrumb>
        </div>

        <div class="navigation-right">未确认上级来文数量：{{ sjlwsl }}</div>
      ...
      <el-card class="box-card">
        ...
        <el-card class="box-card  Children">
          <div slot="header" class="clearfix">
            <span>基本信息</span>
            <el-button style="float: right; padding: 3px 10px" type="text" @click="submitForm('ruleForm')">保存信息</el-button>
          ...
          <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm">
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="文件类型：">
                  <el-select v-model="ruleForm.name" disabled placeholder="一般文件" style="width:120px;"> </el-select>
                  -
                  <el-select v-model="ruleForm.name" disabled placeholder="上级来文" style="width:120px;"> </el-select>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="来文内容：">
                  <el-input v-model="ruleForm.name" type="textarea" :rows="3" placeholder="请输入内容"> </el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="文号："> <el-input v-model="ruleForm.name"></el-input></el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="收文时间：">
                  <el-date-picker v-model="ruleForm.name" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd"> </el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="来文份数："> <el-input v-model="ruleForm.name"></el-input></el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="登记日期："> <el-date-picker v-model="ruleForm.name" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd"> </el-date-picker></el-form-item>
              </el-col>
              <el-col :span="12">
