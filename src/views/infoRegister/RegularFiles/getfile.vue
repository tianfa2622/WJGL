  ...
  <div>
    <div class="container">
        ...
        <div slot="header" class="clearfix">
          ...
          <el-row type="flex" justify="space-around">
            <el-col :span="5">
              ...
              <!-- <svg v-show="false" id="barcode"></svg>
              <el-button v-print="printObj" style="margin-left:10px" :disabled="barcodeData === null">条形码打印</el-button> -->
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="来文单位：" prop="company">
                  <!-- <el-select v-model="ruleForm.jeremy_unit" style="width:100%" clearable placeholder="请选择单位"> <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"> </el-option> </el-select> -->
      ...
      <el-card class="box-card">
        ...
        <el-table :data="tableData" border style="width: 100%" height="500" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="文件类型" prop="file_type" align="center" :resizable="false">
            <template slot-scope="scope">
    ...
    <el-dialog title="选择人员" :visible.sync="dialogFormVisible" center :close-on-click-modal="false">
      ...
      <div slot="footer">
        ...
        <el-button type="primary" @click="personnelDetermine">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
