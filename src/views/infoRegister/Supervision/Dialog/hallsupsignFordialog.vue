<template>
  <div>
    <el-dialog title="厅批督办件-签收文件" :visible.sync="sigDialogVisible" :close-on-click-modal="closeonclickmodal" :close-on-press-escape="closeonpressescape" width="30%" center>
