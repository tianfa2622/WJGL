    ...
    <div class="container">
            ...
            <el-row>
              ...
              <el-col :span="12">
                ...
                <el-form-item label="界别：">
                  <el-input v-model="ruleForm.name" placeholder="请输入界别"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="政协提案编号：">
                  <el-input v-model="ruleForm.name" placeholder="请输入提案编号"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="领衔委员：">
                  <el-input v-model="ruleForm.name" placeholder="请输入领衔委员"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
      ...
      <el-card class="box-card">
        ...
        <el-table :data="tableData" border style="width: 100%" height="500" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="政协提案号" prop="number" :resizable="false" align="center"> </el-table-column>
...
import { searchAll, Add, Del, getDicGroupBy, searchOne, ModifyApi, searchAlreadyPush, searchCanPush } from '@/api/infoRegister/Proposal/plan'
