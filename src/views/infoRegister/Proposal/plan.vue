    ...
    <div class="container">
      <div class="navigation">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>政协提案</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      ...
      <el-card class="box-card">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="标题：" prop="title">
                  <el-input v-model="ruleForm.title" resize="none" type="textarea" :rows="4" placeholder="请输入内容"> </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="来文单位：">
                  <!-- <el-select v-model="ruleForm.documentUnit" style="width:100%" clearable placeholder="请选择来文单位"> <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"> </el-option> </el-select> -->
                  <el-input v-model="ruleForm.documentUnit" placeholder="请输入来文单位"></el-input>
                </el-form-item>
                <el-form-item label="界别：">
                  <el-input v-model="ruleForm.circles" placeholder="请输入界别"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="政协提案编号：">
                  <el-input v-model="ruleForm.number" placeholder="请输入提案编号"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="交办时间：">
                  <el-date-picker v-model="ruleForm.assignmentTime" style="width:100%" type="datetime" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd HH:mm:ss"> </el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="主办单位：">
                  <!-- <el-select v-model="ruleForm.hostUnit" style="width:100%" clearable placeholder="请选择主办单位"> <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"> </el-option> </el-select> -->
                  <el-input v-model="ruleForm.hostUnit" placeholder="请输入主办单位"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="领衔委员：">
                  <el-input v-model="ruleForm.leadingMember" placeholder="请输入领衔委员"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="分办单位：">
                  <!-- <el-select v-model="ruleForm.subUnit" style="width:100%" clearable placeholder="请选择分办单位"> <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"> </el-option> </el-select> -->
                  <el-input v-model="ruleForm.subUnit" placeholder="请输入分办单位"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="办公电话：" prop="officePhone">
                  <el-input v-model="ruleForm.officePhone" placeholder="请输入办公电话"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="会办单位：">
                  ...
                  <el-input v-model="ruleForm.organization" placeholder="请输入会办单位"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="通讯地址：">
                  <el-input v-model="ruleForm.postalAddress" placeholder="请输入通讯地址"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="备注：">
                  <el-input v-model="ruleForm.remarks" resize="none" type="textarea" :rows="4" placeholder="请输入内容"> </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="届：" prop="session">
                  <el-input v-model.number="ruleForm.session" placeholder="请输入届"></el-input>
                </el-form-item>
                <el-form-item label="次：" prop="second">
                  <el-input v-model.number="ruleForm.second" placeholder="请输入次"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
        ...
        <el-card v-if="$store.state.code == 1" class="box-card  Children">
          ...
          <el-row type="flex" justify="center" class="BJ_Ps_style">
            <el-form ref="FinishForm" :model="bjsj" :disabled="disabled === true ? disabled : bjsj.situation" label-width="110px" class="demo-dynamic">
              <el-col :span="22">
      ...
      <el-card class="box-card">
        <el-row type="flex" justify="space-around" class="search_box">
          <el-col :span="7">
            ...
            <el-input v-model="conditionInputs.serialNum" style="width:70%" placeholder="请输入流水号" clearable> </el-input>
          </el-col>
          <el-col :span="7">
            <span class="span_color">标题:</span>
            <el-input v-model="conditionInputs.title" style="width:70%" placeholder="请输入标题" clearable> </el-input>
          </el-col>
          <el-col :span="7">
        ...
        <el-table :data="tableData" border style="width: 100%" height="500" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="政协提案编号" prop="number" :resizable="false" align="center"> </el-table-column>
          ...
          <el-table-column label="标题" prop="title" :resizable="false" align="center"> </el-table-column>
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.ruleForm.assignmentTime = dayjs(this.ruleForm.assignmentTime).format('YYYY-MM-DD HH:mm:ss')
