      ...
      <el-col :span="24">
        ...
        >
          ...
          <el-submenu index="2">
            ...
            <el-menu-item-group>
              <template slot="title">一般文件</template>
              <el-menu-item index="/instructions">呈批件</el-menu-item>
              <el-menu-item index="/getfile">上级来文</el-menu-item>
              <el-menu-item index="/level">平级和下级来文</el-menu-item>
              <el-menu-item index="/usermessage">群众来信</el-menu-item>
              <el-menu-item index="/other">其他</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group title="督办件">
              <el-menu-item index="/topSupervision">上级督办件</el-menu-item>
              <el-menu-item index="/hallSupervision">厅批督办件</el-menu-item>
            </el-menu-item-group>
            <el-menu-item-group title="提案建议">
          ...
          <el-submenu index="6">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="/allLeaddayForm"
                >所有厅领导每日行程表</el-menu-item
              >
              <el-menu-item index="/eachLeadWeekForm"
                >每个厅领导每周行程表</el-menu-item
              >
              <el-menu-item index="/allLeadWeekForm"
                >所有厅领导每周行程表</el-menu-item
              >
            </el-menu-item-group>
            <el-menu-item-group title="会议室管理">
              <el-menu-item index="/roomweekusestate"
                >会议室一周使用情况表</el-menu-item
              >
            </el-menu-item-group>
            <el-menu-item-group title="文件报表">
              <el-menu-item index="/instructionsState"
                >呈批件情况一览表</el-menu-item
              >
              <el-menu-item index="/circularsState"
                >传阅件情况一览表</el-menu-item
              >
              <el-menu-item index="/superviseState"
                >督办件情况一览表</el-menu-item
              >
